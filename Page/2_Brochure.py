...
with st.expander('Df pedidos'):
    df = pd.read_csv("../Store-Sale-Analysis/Data/df_pedidos.csv")
    st.write(df)
with st.expander('Df items_pedidos'):
    df = pd.read_csv("../Store-Sale-Analysis/Data/df_items_pedidos.csv")
    st.write(df)
    
with st.expander('Df productos'):
    df = pd.read_csv("../Store-Sale-Analysis/Data/df_productos.csv")
    st.write(df)

with st.expander('Df vendedores'):
    df = pd.read_csv("../Store-Sale-Analysis/Data/df_vendedores.csv")
    st.write(df)
...
img = Image.open("../img/pantalon.png")
